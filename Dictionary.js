...
const items = [
    ...
    },
    {
        ...
        creatorName: "'Echoes' is developed by Severino Alfonso and Loukia Tsafoulia as part of their S+T+Arts (Science, Technology, and Arts) ReSilence EU residency in collaboration with Up2metric computer vision company. Scientific and technology partners to the project are the Center for Research & Technology, Hellas (CERTH), the University of Maastricht Brain and Emotion Laboratory, the University of Genoa’s Casa Paganini-InfoMus and the Jefferson Health Center for Autism and Neurodiversity.<br><br>The project is also partially supported with funds from the Institute for Smart and Healthy Cities, Thomas Jefferson University, particularly the project’s video component “VOICES: Experiences and Expressions.” Collaborators to the VOICES component are the Jefferson Health Center for Autism and Neurodiversity, Dr. Rosie Frasso, health equity researcher and public health educator at Thomas Jefferson University, and autism advocates and faculty at the College of Architecture and the Built Environment at TJU, Shannon McLain and Rachel Updegrove.",
        color: "#ffffff",
        categoryTags: ["Innovate", "Access"], // Updated
        imagePrimary: "images/2_reflection.jpg",
        imageSecondary: ["images/4_connection_details.jpg", "images/3_steps.jpg", "images/2_reflection.jpg"] // Multiple images in an array
    },
    {
        ...
        creatorName: "Alfonso, Severino, and Tsafoulia, Loukia. “Embodied Imaginaries of Interior Space: A framework for dynamic environments and sensory inclusion.” In Interiors on Edge, edited by Erica Morawski, Deborah Schneiderman, Karin Tehve, Keena Suh, and Karyn Zieve, 81-106. London: Routledge, 2024.<br><br>Alfonso, Severino, and Loukia Tsafoulia, “Synesthesia: An Experiment on Enacted Surfaces,” Metode, (2023), vol. 1 ‘Deep Surface.’",
        color: "#ffffff",
        categoryTags: ["Adapt", "Access"], // Updated
        imagePrimary: "images/2_reflection.jpg",
        imageSecondary: ["images/4_connection_details.jpg", "images/3_steps.jpg", "images/2_reflection.jpg"] // Multiple images in an array
